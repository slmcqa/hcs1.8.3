...
describe "SLMC :: Inpatient Manual Discount Type" do
  ...
  before(:all) do
    ...
    @@employee = "1104000682"
    @@employee_dependent = "1104000683"
    @@board_member = "1104000705"
    @@board_member_dependent = "1104000706"
    @@doctor = "1104000751"
    @@doctor_dependent = "1104000734"
    @esc_no = "0004589"
  ...
  it "Account Class : Individual - Create and Admits patient" do
    ...
    slmc.create_new_admission(:room_charge => "DE LUXE PRIVATE", :rch_code => "RCH07", :org_code => "0278", :diagnosis => "GASTRITIS").should == "Patient admission details successfully saved."
  end
  ...
  it "Account Class : Individual - Goes to Discount Page and Verifies Discount Type" do
    slmc.login("pba29", @password).should be_true
  ...
  it "Account Class : HMO - Create and Admit patient" do
    ...
    slmc.create_new_admission(:account_class => "HMO", :room_charge => "DE LUXE PRIVATE", :rch_code => "RCH07", :org_code => "0278", :guarantor_code => "ASAL002", :diagnosis => "GASTRITIS").should == "Patient admission details successfully saved."
  end
  ...
  it "Account Class : Company - Create and Admit patient" do
    ...
    slmc.create_new_admission(:account_class => "COMPANY", :room_charge => "DE LUXE PRIVATE", :rch_code => "RCH07", :org_code => "0278", :guarantor_code => "ABSC001", :diagnosis => "GASTRITIS").should == "Patient admission details successfully saved."
  end
  ...
  it "Account Class : Social Service - Admit and Creates patient" do
    ...
    slmc.create_new_admission(:account_class => "SOCIAL SERVICE", :org_code => "0278", :rch_code => "RCH07", :room_charge => "DE LUXE PRIVATE", :diagnosis => "GASTRITIS", :doctor_code => "6726", :esc_no => @esc_no).should == "Patient admission details successfully saved."
  end
  ...
  it "Account Class : Women's Board Member - Admit and Creates patient" do
    ...
    slmc.create_new_admission(:account_class => "WOMEN'S BOARD MEMBER", :org_code => "0278", :rch_code => "RCH07", :room_charge => "DE LUXE PRIVATE",
  ...
  it "Account Class : Women's Board Member Dependent - Admit and Creates patient" do
    ...
    slmc.create_new_admission(:account_class => "WOMEN'S BOARD DEPENDENT", :org_code => "0278", :rch_code => "RCH07",
    :room_charge => "DE LUXE PRIVATE", :diagnosis => "GASTRITIS", :doctor_code => "6726",  :guarantor_code => "WOMB001").should == "Patient admission details successfully saved."
  end
...
## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
  ...
  it "Individual - Add First Discount (Courtesy Discount = 5000)" do
    ...
    slmc.add_discount(:discount => "Courtesy Discount", :discount_scope => "ACROSS THE BOARD", :discount_type => "Fixed", :discount_rate => "5000", :close_window => true, :save => true).should be_true
  end
...
## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ## ##
  ...
  it "Individual - Print Gatepass of patient" do
    slmc.login("sel_0278_validator", @password).should be_true
    slmc.nursing_gu_search(:pin => @@pin2)
