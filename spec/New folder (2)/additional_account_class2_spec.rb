...
describe "SLMC :: Additional Account Class 2  (Company & House Staff)" do
  ...
  before(:all) do
    ...
    @user = "billing_spec_user3"
    @pba_user = "sel_pba7"
    @or_user = "or21"
    @oss_user = "sel_oss7"
    @dr_user = "sel_dr4"
    @er_user = "sel_er4"
    @wellness_user = "sel_wellness2"
  ...
  it "Company : OSS Checks Computation of Gross, Discount and Balance Due" do
    ...
    ((slmc.truncate_to((@@summary[:total_gross_amount].to_f - @@pos[:gross]),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_promo].to_f - @@pos[:discount]),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_net_amount].to_f - @@net_amount),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_amount_due].to_f - @@balance_due),2).to_f).abs).should <= 0.02
  end
  ...
  it "Company : OR - Compute Payment and Verifies Company Discount on Ordered items" do
    ...
    @@summary = slmc.get_billing_details_from_payment_data_entry
    ((slmc.truncate_to((@@summary[:hospital_bill].to_f - @@gross),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:room_charges].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:adjustments].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:philhealth].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:discounts].to_f - @@total_discount),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:ewt].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:gift_check].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:payments].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:charged_amount].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_hospital_bills].to_f - @@total_hospital_bill),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:pf_amount].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:pf_payments].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:pf_charged].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_amount_due].to_f - @@total_hospital_bill),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_payments].to_f - 0.0),2).to_f).abs).should <= 0.02
  ...
  it "Company : Wellness Outpatient - Compute Payment and Verifies Company Discount on Ordered items" do
    ...
    @@summary = slmc.get_summary_totals
    ((slmc.truncate_to((@@summary[:total_gross_amount].to_f - @@gross),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_promo].to_f - @@discount),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_class_discount].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_package_discount].to_f - @@total_package_discount),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_net_amount].to_f - @@package_amount),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_pf].to_f - @@pf_fee),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_amount_due].to_f - @@total_amount_due),2).to_f).abs).should <= 0.02
  end
  ...
  it "Company : Wellness Inpatient - Verifies Payment" do
    ...
    ((slmc.truncate_to((@@summary[:adjustments].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:philhealth].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:discounts].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:ewt].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:gift_check].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:payments].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:charged_amount].to_f - 0.0),2).to_f).abs).should <= 0.02
    ...
    ((slmc.truncate_to((@@summary[:total_amount_due].to_f - @@total_amount_due),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:total_payments].to_f - 0.0),2).to_f).abs).should <= 0.02
    ((slmc.truncate_to((@@summary[:balance_due].to_f - @@total_amount_due),2).to_f).abs).should <= 0.02
  end
