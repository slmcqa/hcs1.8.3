...
#  it "Bug #25158 - PhilHealth-OSS * Doesn't compute PF claim for anesthesiologist in Cataract package claim type = Accounts Receivable" do
#    slmc.login("sel_oss5", @password).should be_true
#    slmc.go_to_das_oss
#    slmc.patient_pin_search(:pin => @@pin)
#    slmc.click_outpatient_order.should be_true
...
#  end
#
#  it "Checks for actual operation benefit claim with cataract operations is correct" do
...
#  end
#
#  it "Checks for actual drugs and lab benefit with cataract operations is correct" do
...
#  end
#
#  it "Checks if PF Claims for anesthesiologist and surgeon with cataract operations is correct" do
