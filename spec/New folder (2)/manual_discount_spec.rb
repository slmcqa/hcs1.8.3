...
#    @selenium_driver.evaluate_rooms_for_admission('0287','RCH08')
    @password = "123qweuser"
    @employee = "1108008780"#guarantor_code=>"0109992"
    @maternity_employee = "1108008782"#guarantor_code=>"0109991"
    #@employee_dependent = "1108008783"#benefactor_code=>"0109992" SELENIUM_TAN,SELENIUM_RACHEL
    @employee_dependent = "1202032888"
    @employee_dependent1 = "1108008881"#benefactor_code =>"0109995",SEL_EMPLOYEE,SELENIUM_RACHEL
    @employee1 = "1108008828"#guarantor_code=>"0209992"
    @oss_employee = "1108008900"#SELENIUM_EMPLOYEE1
    @oss_maternity = "1108008901"#SELENIUM_EMPLOYEE2
    @oss_dependent = "1108008908"#Sel_employee, Rachel Mae Cheng
    @user = "billing_spec_user4"
#    @pba_user = "sel_pba12"
    @pba_user = "pba27" #endoscopic
    @ss_user = "sel_ss2"
    @oss_user = "sel_oss9"
...
#  end
  ...
  it"Account Class = Employee , Discount Type = Courtesy , Patient Type = Inpatient - Create New Admission" do
    ...
    slmc.create_new_admission(:account_class => "EMPLOYEE", :org_code => "0287", :rch_code => "RCH08",
      :room_charge => "REGULAR PRIVATE", :diagnosis => "GASTRITIS", :doctor_code => "6726",:guarantor_code=>"0209992").should == "Patient admission details successfully saved."
  end
  ...
  it"Account Class = Social Service , Discount Type = Courtesy , Patient Type = Inpatient  - Create New Admission" do
    ...
    slmc.create_new_admission( :account_class => "SOCIAL SERVICE", :esc_no => "216", :dept_code => "OBSTETRICS AND GYNECOLOGY",
  ...
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Outpatient , If yr of service >= 1 AND Non-Maternity case - Add Guarantor" do
    slmc.oss_add_guarantor(:guarantor_type =>  'EMPLOYEE', :acct_class => 'EMPLOYEE', :guarantor_code => "0209991", :guarantor_add => true)
  end
  ...
  it"Account Class = Employee , Discount Type = Employee , Patient Type = Outpatient , If yr of service < 1 OR Maternity case - Add Guarantor" do
    slmc.oss_add_guarantor(:guarantor_type =>  'EMPLOYEE', :acct_class => 'EMPLOYEE', :guarantor_code => "0209990", :guarantor_add => true)
  end
