...
describe "SLMC :: Inpatient - Philhealth Data Entry" do
  ...
  it "Case Type can be selected from the drop down list: Ordinary Case, Intensive Case, Catastrophic Case and Super Catastrophic Case" do
  ...
  it "View Computed PhilHealth – Accounts Receivable (Final)" do
    ...
    puts "There are no saved FINAL Philhealth, manually validate this sample" if @stop_row == nil
