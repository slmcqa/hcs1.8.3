...
describe "OSS SELECTIVE DISCOUNT (EMPLOYEE & HMO)" do
  ...
  before(:all) do
    ...
    @password = "123qweuser"
    @oss_user = "sel_oss10"
    @selective_patient = "1108010706" #SELENIUM_SELECTIVE,0824011
    @selective_patient2 = "1108010708" #SELENIUM_SELECTIVE_EM,0824013
    @drugs =  "049000075"
    @orders = {"010001662" => 1,
                        "010001525" => 1,
                        "010000007" => 1,
  ...
  it"OSS - EMPLOYEE - Scenario 1 - Guarantor" do
       slmc.oss_add_guarantor(:guarantor_type =>  'EMPLOYEE', :acct_class => 'EMPLOYEE', :guarantor_code => "0824011", :guarantor_add => true)
  end
