...
describe "SLMC :: PhilHealth Newborn Package change of logic- Feature #39737" do
  ...
  before(:all) do
    ...
    @medical_case_rate = [
      ...
      "Dengue II (DHF Grades III and IV)",
  ...
  it "NB01: Order items for newborn" do
    slmc.login("billing_spec_user6", @password).should be_true
  ...
  it "NB01: Computes PhilHealth" do
    ...
    @@nb_philhealth1 = slmc.philhealth_computation(:claim_type => "REFUND", :diagnosis => "Z38.0", :medical_case_type => "ORDINARY CASE", :compute => true)
  end
  ...
  it "NB01: Total Benefit Claim" do
     @@nb_philhealth1[:total_actual_benefit_claim].should == "1000.00"
  end
  ...
  it "NB02: Transfer mother from DR to inpatient" do
    slmc.go_to_outpatient_nursing_page
    slmc.outpatient_to_inpatient(@dr_patient2.merge(:pin => @@slmc_mother_pin2, :username => "sel_adm7", :password => @password, :room_label => "REGULAR PRIVATE", :rch_code => "RCH08", :org_code => "0287")).should be_true
  end
  ...
  it "NB02: Computes PhilHealth" do
    ...
    slmc.go_to_page_using_visit_number("PhilHealth", slmc.visit_number)
    @@nb_philhealth2 = slmc.philhealth_computation(:claim_type => "REFUND", :diagnosis => "A00", :medical_case_type => "ORDINARY CASE", :compute => true)
  end
  ...
  it "NB03: Computes PhilHealth" do
    ...
    slmc.go_to_page_using_visit_number("PhilHealth", slmc.visit_number)
    @@nb_philhealth3 = slmc.philhealth_computation(:claim_type => "REFUND", :diagnosis => "Z38.0", :medical_case_type => "ORDINARY CASE", :compute => true)
  end
  ...
  it "Screen: Case Rate Package Medical" do
    slmc.get_select_options("caseRateNo").should == (@medical_case_rate)
  end
  ...
  it "Screen: View details" do
    @@ph1 = slmc.philhealth_computation(:claim_type => "REFUND", :diagnosis => "Z38.0", :case_rate_type => "SURGICAL", :case_rate => "Cholecystectomy", :compute => true)
