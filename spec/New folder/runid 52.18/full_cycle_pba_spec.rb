...
describe "Patient Billing and Accounting Full Cycle Process Spec" do
  ...
  before(:all) do
    ...
    @password = "123qweuser"
    @oss_user = "sel_oss10"
    @pba_user = "sel_pba16" #role_endoresement_tagging, role_endorsement_tagging_mngr
    @misc_user = "sel_misc1"
...
### Patient Billing and Accounting - View and Reprinting
  ...
  it"Create patient for refund deleting" do
    ...
    slmc.pba_hb_deposit_payment(:deposit => true, :cash => "100000")
...
#  end
  ...
  it"A/R Payments - Display Account Groups in dropdown"do
    ...
    (slmc.get_text"accountGroup").should == @account_group
  end
  ...
  it "Feature #43215 - Verify each item in database (REF_MISC_TYPE)" do
    ...
    @misc_type.should_not == @@inactive_misc_type.to_s
  end
