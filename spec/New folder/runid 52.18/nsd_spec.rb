...
describe "SLMC :: Normal Spontaneous Delivery Case" do
  ...
  before(:all) do
    ...
    @or_user = "or29"
#    @pba_user = "pba27"
    @pba_user = "sel_pba12" #manual spec
    @er_user = "sel_er5"
    @dr_user = "sel_dr3"
...
#        end
#        @@oss_ph[:er_actual_operation_benefit_claim].should == ("%0.2f" %(@@actual_operation_benefit_claim2))
#      else
...
#      slmc.get_text(Locators::OSS_Philhealth.claims_history).should != "Nothing found to display."
  ...
  it "(5th nsd scenario) Administratively discharge patient" do
    slmc.login(@pba_user, @password).should be_true
    slmc.go_to_patient_billing_accounting_page
    slmc.pba_search(:with_discharge_notice => true, :pin => @@visit_no)
